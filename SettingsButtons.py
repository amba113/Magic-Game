...
class SettingsButton():
    ...
    def __init__(self, pos, kind):
        ...
        self.images = {"controls": pygame.image.load("Images/Control Set Button.png"),
                       ...
                       "play": pygame.transform.scale(pygame.image.load("Images/Play Button.png"), [350, 100]),
                       "sign": pygame.transform.scale(pygame.image.load("Images/Signin Button.png"), [350, 100]),
                       "close": pygame.image.load("Images/Store Close.png"),
                       "back": pygame.transform.scale(pygame.image.load("Images/BackButton.png"), [50, 50]),
